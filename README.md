# Own version of fastbook setup code
> Deep Learning for Coders with fastai and PyTorch: AI Applications Without a PhD - the book and the course

This modified code allows to run colab without binding My Drive when it is not needed. 

Text below is the original README file.
